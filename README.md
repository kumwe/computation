...
retains its portable source/corpus bytes exactly and requires the published Engine/PHP extension 1.0.3.
...
self-attest the Computation 0.3.3 successor; its release and independent consumer verification follow the gate.
