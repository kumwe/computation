...
This is the common Kumwe package release contract. Apply it to every maintained package.
...
`release-verified` and downstream adoption decisions under the package release protocol.
