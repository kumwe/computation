 ...
 */
    ...
    {
        return ['wire_version' => 1, 'max_input_bytes' => $this->maxInputBytes, 'max_output_bytes' => $this->maxOutputBytes, 'max_documents' => $this->maxDocuments, 'max_findings' => $this->maxFindings, 'max_path_depth' => $this->maxPathDepth, 'max_parameter_bytes' => $this->maxParameterBytes, 'max_instructions' => $this->maxInstructions, 'max_milliseconds' => $this->maxMilliseconds];
    }
 ...
 */
    ...
    {
        Guard::shape($data, ['wire_version', 'max_input_bytes', 'max_output_bytes', 'max_documents', 'max_findings', 'max_path_depth', 'max_parameter_bytes', 'max_instructions', 'max_milliseconds']);
        return new self(Guard::integer($data['max_input_bytes'], 1), Guard::integer($data['max_output_bytes'], 1), Guard::integer($data['max_documents'], 1), Guard::integer($data['max_findings'], 1), Guard::integer($data['max_path_depth'], 1), Guard::integer($data['max_parameter_bytes'], 1), Guard::integer($data['max_instructions'], 1), Guard::integer($data['max_milliseconds'], 1));
    }
}
