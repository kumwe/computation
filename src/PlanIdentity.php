...
final readonly class PlanIdentity
{
    ...
    public function toArray(): array
    {
        return ['wire_version' => 1,
             ...
             'definition_digest' => $this->definitionDigest,
             'schema_digest' => $this->schemaDigest,
             'options_digest' => $this->optionsDigest,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            Guard::version($data['program_version']),
            Guard::digest($data['source_digest']),
            Guard::token($data['generation']),
            Guard::digest($data['definition_digest']),
            Guard::digest($data['schema_digest']),
            Guard::digest($data['options_digest']),
            CapabilitySet::fromArray(Guard::object($data['capabilities']))
        );
    }
}
